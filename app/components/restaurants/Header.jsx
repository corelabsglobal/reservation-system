...
export default function RestaurantHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-gray-900 bg-opacity-90 text-gray-900 flex justify-between items-center px-6 py-4 z-60 shadow-md border-b border-gray-200">
      <a href="/">
