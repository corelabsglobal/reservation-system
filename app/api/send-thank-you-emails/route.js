...
export default async function handler(req, res) {
  ...
  try {
    ...
    for (const reservation of reservations) {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <a href="${process.env.RESTAURANT_BOOKING_URL || '#'}/${restaurant.url}" class="button">Reserve Again</a>
      ...
      const mailOptions = {
        from: `"${reservation.restaurants.name}" <${process.env.SMTP_FROM_EMAIL}>`,
        to: reservation.email,
        subject: `Thank You for Dining at ${reservation.restaurants.name}`,
        html: emailHtml,
        replyTo: reservation.restaurants.owner?.email || process.env.SMTP_FROM_EMAIL,
      };
